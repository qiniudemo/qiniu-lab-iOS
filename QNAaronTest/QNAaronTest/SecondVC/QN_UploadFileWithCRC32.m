...
#import "QN_UploadFileWithCRC32.h"

@interface QN_UploadFileWithCRC32 ()

@property (nonatomic, strong) UIImage * pickImage;

@end

@implementation QN_UploadFileWithCRC32
...
-(void)uploadImageToQNFilePath:(NSString *)filePath
{
    ...
    } params:nil checkCrc:self.isUseCRC32.on cancellationSignal:nil];

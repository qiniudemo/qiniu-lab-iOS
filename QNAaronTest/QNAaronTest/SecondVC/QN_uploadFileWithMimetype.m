...
-(void)getTokenFromQN
{
    [HTTPRequestPost hTTPRequest_GetpostBody:nil andUrl:@"api/simple_upload/with_mimetype_upload_token.php" andSucceed:^(NSURLSessionDataTask *task, id responseObject) {

...
#import "QN_uploadFileWithMimetype.h"

@interface QN_uploadFileWithMimetype ()

@property (nonatomic, strong) UIImage * pickImage;

@end

@implementation QN_uploadFileWithMimetype
...
-(void)getTokenFromQN
{
    [HTTPRequestPost hTTPRequest_GetpostBody:nil andUrl:@"~aaron/qiniu-api-server/php-v6/api/simple_upload/with_mimetype_upload_token.php" andSucceed:^(NSURLSessionDataTask *task, id responseObject) {
...
-(void)uploadImageToQNFilePath:(NSString *)filePath
{
    ...
    QNUploadOption * uploadOption = [[QNUploadOption alloc] initWithMime:self.fillMimetyep.text progressHandler:^(NSString *key, float percent) {
